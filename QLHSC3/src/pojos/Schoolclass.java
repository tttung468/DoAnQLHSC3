...
public class Schoolclass implements java.io.Serializable {
    ...
    public Schoolclass(Date createddate, Date modifieddate) {
        this.createddate = createddate;
        this.modifieddate = modifieddate;
    }

    public Schoolclass(Grade grade, String code, String name, Boolean isdeleted, Date createddate, String createdby, Date modifieddate, String modifiedby, Set scores, Set formteacherassignments, Set teacherassignments, Set conducts, Set observations, Set studentofclasses) {
        this.grade = grade;
        this.code = code;
        this.name = name;
