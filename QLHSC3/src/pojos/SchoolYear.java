...
public class SchoolYear extends Generic implements java.io.Serializable {
    ...
    public SchoolYear(String code, Integer lowerBound, Integer upperBound, String theme, Boolean isDeleted, Date createdDate, String createdBy, Date modifiedDate, String modifiedBy) {
        this.code = code;
