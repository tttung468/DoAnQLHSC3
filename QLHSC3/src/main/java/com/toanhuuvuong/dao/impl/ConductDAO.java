...
import com.toanhuuvuong.dao.IConductDAO;
import com.toanhuuvuong.model.Conduct;
import com.toanhuuvuong.pagination.Pageable;
import com.toanhuuvuong.sort.Sorter;

public class ConductDAO extends AbstractHibernateDAO<Conduct> implements IConductDAO {
	public ConductDAO() {
...
//	              AND conduct.student.id=? AND conduct.schoolClass.id=? AND conduct.isDeleted=?
		...
		if (conduct != null) {
			...
			if (conduct.getSemester() != null && conduct.getConductType() != null) {
				sql.append(" and");
			}

			// conduct.semester.id=?
			if (conduct.getSemester() != null) {
				sql.append(" conduct.semester.name = :semesterName");
			}
			if (conduct.getSchoolYear() != null
					&& (conduct.getConductType() != null || conduct.getSemester() != null)) {
				sql.append(" and");
			}

			// conduct.schoolYear.id=?
			if (conduct.getSchoolYear() != null) {
				sql.append(" conduct.schoolYear.code = :schoolYearCode");
			}
			if (conduct.getTeacher() != null && (conduct.getConductType() != null || conduct.getSemester() != null
			...
			if (conduct.getStudent() != null && (conduct.getConductType() != null || conduct.getSemester() != null
					|| conduct.getSchoolYear() != null || conduct.getTeacher() != null)) {
				sql.append(" and");
			}
			...
			if (conduct.getSchoolClass() != null && (conduct.getConductType() != null || conduct.getSemester() != null
					|| conduct.getSchoolYear() != null || conduct.getTeacher() != null
			...
			if (conduct.getIsDeleted() != null && (conduct.getConductType() != null || conduct.getSemester() != null
					|| conduct.getSchoolYear() != null || conduct.getTeacher() != null || conduct.getStudent() != null
			...
			if (searchKey != null && (conduct.getConductType() != null || conduct.getSemester() != null
					|| conduct.getSchoolYear() != null || conduct.getTeacher() != null || conduct.getStudent() != null
					|| conduct.getSchoolClass() != null || conduct.getIsDeleted() != null)) {
				sql.append(" and");
			}
		}
...
//	        LIMIT ?, ?
	...
	public Query setValueForHQL(Pageable<Conduct> pageable, Session session, String hql) {
		...
		if (conduct != null) {
			...
			if (conduct.getSemester() != null) {
				query.setParameter("semesterName", conduct.getSemester().getName());
			}
			if (conduct.getSchoolYear() != null) {
				query.setParameter("schoolYearCode", conduct.getSchoolYear().getCode());
			}
			if (conduct.getTeacher() != null) {
