...
import com.toanhuuvuong.dao.IObservationDAO;
import com.toanhuuvuong.model.Observation;
import com.toanhuuvuong.pagination.Pageable;
import com.toanhuuvuong.sort.Sorter;

public class ObservationDAO extends AbstractHibernateDAO<Observation> implements IObservationDAO {
...
//              AND observation.schoolClass.id=? AND observation.isDeleted=?
		...
		if (observation != null) {
			...
			if (observation.getSchoolYear() != null && observation.getContent() != null) {
				sql.append(" and");
			}

			// observation.schoolYear.id=?
			if (observation.getSchoolYear() != null) {
				sql.append(" observation.schoolYear.code = :schoolYearCode");
			}
			if (observation.getTeacher() != null
					&& (observation.getContent() != null || observation.getSchoolYear() != null)) {
				sql.append(" and");
			}
			...
			if (observation.getStudent() != null && (observation.getContent() != null
					|| observation.getSchoolYear() != null || observation.getTeacher() != null)) {
				sql.append(" and");
			}
			...
			if (observation.getSchoolClass() != null
					&& (observation.getContent() != null || observation.getSchoolYear() != null
							|| observation.getTeacher() != null || observation.getStudent() != null)) {
				sql.append(" and");
			}
			...
			if (observation.getIsDeleted() != null && (observation.getContent() != null
					|| observation.getSchoolYear() != null || observation.getTeacher() != null
					|| observation.getStudent() != null || observation.getSchoolClass() != null)) {
				sql.append(" and");
			}
			...
			if (searchKey != null && (observation.getContent() != null || observation.getSchoolYear() != null
					|| observation.getTeacher() != null || observation.getStudent() != null
					|| observation.getSchoolClass() != null || observation.getIsDeleted() != null)) {
				sql.append(" and");
			}
		}
...
//        LIMIT ?, ?
	...
	public Query setValueForHQL(Pageable<Observation> pageable, Session session, String hql) {
		...
		if (observation != null) {
			...
			if (observation.getSchoolYear() != null) {
				query.setParameter("schoolYearCode", observation.getSchoolYear().getCode());
			}
			if (observation.getTeacher() != null) {
