...
public class HRStaffDAO extends AbstractHibernateDAO<HRStaff> implements IHRStaffDAO {
	public HRStaffDAO() {
...
//              AND hrStaff.account.id=? AND hrStaff.isDeleted=?
		...
		if (hrStaff != null) {
			...
			if (hrStaff.getCode() != null && hrStaff.getName() != null) {
				sql.append(" and");
			}
			...
			if (hrStaff.getPhone() != null && (hrStaff.getCode() != null || hrStaff.getName() != null)) {
				sql.append(" and");
			}
			...
			if (hrStaff.getAvatarpath() != null
					&& (hrStaff.getCode() != null || hrStaff.getName() != null || hrStaff.getPhone() != null)) {
				sql.append(" and");
			}
			...
			if (hrStaff.getGender() != null && (hrStaff.getCode() != null || hrStaff.getName() != null
					|| hrStaff.getPhone() != null || hrStaff.getAvatarpath() != null)) {
				sql.append(" and");
			}
			...
			if (hrStaff.getBirth() != null && (hrStaff.getCode() != null || hrStaff.getName() != null
					|| hrStaff.getPhone() != null || hrStaff.getAvatarpath() != null || hrStaff.getGender() != null)) {
				sql.append(" and");
			}
			...
			if (hrStaff.getAddress() != null && (hrStaff.getCode() != null || hrStaff.getName() != null
					|| hrStaff.getPhone() != null || hrStaff.getAvatarpath() != null || hrStaff.getGender() != null
			...
			if (hrStaff.getSalary() != null && (hrStaff.getCode() != null || hrStaff.getName() != null
					|| hrStaff.getPhone() != null || hrStaff.getAvatarpath() != null || hrStaff.getGender() != null
					|| hrStaff.getBirth() != null || hrStaff.getAddress() != null)) {
				sql.append(" and");
			}
			...
			if (hrStaff.getAccount() != null && (hrStaff.getCode() != null || hrStaff.getName() != null
					|| hrStaff.getPhone() != null || hrStaff.getAvatarpath() != null || hrStaff.getGender() != null
					|| hrStaff.getBirth() != null || hrStaff.getAddress() != null || hrStaff.getSalary() != null)) {
				sql.append(" and");
			}
			...
			if (hrStaff.getIsDeleted() != null && (hrStaff.getCode() != null || hrStaff.getName() != null
					|| hrStaff.getPhone() != null || hrStaff.getAvatarpath() != null || hrStaff.getGender() != null
					|| hrStaff.getBirth() != null || hrStaff.getAddress() != null || hrStaff.getSalary() != null
			...
			if (searchKey != null && (hrStaff.getCode() != null || hrStaff.getName() != null
					|| hrStaff.getPhone() != null || hrStaff.getAvatarpath() != null || hrStaff.getGender() != null
					|| hrStaff.getBirth() != null || hrStaff.getAddress() != null || hrStaff.getSalary() != null
					|| hrStaff.getAccount() != null || hrStaff.getIsDeleted() != null)) {
				sql.append(" and");
			}
		}
