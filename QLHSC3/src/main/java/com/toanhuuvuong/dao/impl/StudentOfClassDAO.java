...
//              AND studentOfClass.isDeleted=?
		...
		if (studentOfClass != null) {
			...
			if (studentOfClass.getAbsenceWithoutLeave() != null && studentOfClass.getAbsence() != null) {
				sql.append(" and");
			}
			...
			if (studentOfClass.getStudent() != null
					&& (studentOfClass.getAbsence() != null || studentOfClass.getAbsenceWithoutLeave() != null
							|| studentOfClass.getSemester() != null || studentOfClass.getSchoolYear() != null)) {
				sql.append(" and");
			}
			...
			if (studentOfClass.getSchoolClass() != null && (studentOfClass.getAbsence() != null
					|| studentOfClass.getAbsenceWithoutLeave() != null || studentOfClass.getSemester() != null
					|| studentOfClass.getSchoolYear() != null || studentOfClass.getStudent() != null)) {
				sql.append(" and");
			}
			...
			if (studentOfClass.getIsDeleted() != null
					&& (studentOfClass.getAbsence() != null || studentOfClass.getAbsenceWithoutLeave() != null
							|| studentOfClass.getSemester() != null || studentOfClass.getSchoolYear() != null
							|| studentOfClass.getStudent() != null || studentOfClass.getSchoolClass() != null)) {
				sql.append(" and");
			}
			...
			if (searchKey != null && (studentOfClass.getAbsence() != null
					|| studentOfClass.getAbsenceWithoutLeave() != null || studentOfClass.getSemester() != null
					|| studentOfClass.getSchoolYear() != null || studentOfClass.getStudent() != null
					|| studentOfClass.getSchoolClass() != null || studentOfClass.getIsDeleted() != null)) {
				sql.append(" and");
			}
		}
