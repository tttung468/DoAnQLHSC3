...
//              AND account.role.id = ? AND account.isDeleted = ?
		...
		if (account != null) {
			...
			if (account.getRole() != null && (account.getUsername() != null || account.getPassword() != null)) {
				sql.append(" and");
			}
			...
			if (account.getIsDeleted() != null
					&& (account.getUsername() != null || account.getPassword() != null || account.getRole() != null)) {
				sql.append(" and");
			}
			...
			if (searchKey != null && (account.getUsername() != null || account.getPassword() != null
					|| account.getRole() != null || account.getIsDeleted() != null)) {
				sql.append(" and");
			}
		}
