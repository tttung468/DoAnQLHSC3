...
import com.toanhuuvuong.dao.ITeacherDAO;
import com.toanhuuvuong.model.Teacher;
import com.toanhuuvuong.pagination.Pageable;
import com.toanhuuvuong.sort.Sorter;

public class TeacherDAO extends AbstractHibernateDAO<Teacher> implements ITeacherDAO {
	public TeacherDAO() {
...
//              AND teacher.subject.name=? AND teacher.account.id=? AND teacher.isDeleted=?
		...
		if (teacher != null) {
			...
			if (teacher.getCode() != null && teacher.getName() != null) {
				sql.append(" and");
			}
			...
			if (teacher.getPhone() != null && (teacher.getCode() != null || teacher.getName() != null)) {
				sql.append(" and");
			}
			...
			if (teacher.getAvatarpath() != null
					&& (teacher.getCode() != null || teacher.getName() != null || teacher.getPhone() != null)) {
				sql.append(" and");
			}
			...
			if (teacher.getGender() != null && (teacher.getCode() != null || teacher.getName() != null
					|| teacher.getPhone() != null || teacher.getAvatarpath() != null)) {
				sql.append(" and");
			}
			...
			if (teacher.getBirth() != null && (teacher.getCode() != null || teacher.getName() != null
					|| teacher.getPhone() != null || teacher.getAvatarpath() != null || teacher.getGender() != null)) {
				sql.append(" and");
			}
			...
			if (teacher.getAddress() != null && (teacher.getCode() != null || teacher.getName() != null
					|| teacher.getPhone() != null || teacher.getAvatarpath() != null || teacher.getGender() != null
			...
			if (teacher.getSalary() != null && (teacher.getCode() != null || teacher.getName() != null
					|| teacher.getPhone() != null || teacher.getAvatarpath() != null || teacher.getGender() != null
					|| teacher.getBirth() != null || teacher.getAddress() != null)) {
				sql.append(" and");
			}
			...
			if (teacher.getSubject() != null && (teacher.getCode() != null || teacher.getName() != null
					|| teacher.getPhone() != null || teacher.getAvatarpath() != null || teacher.getGender() != null
					|| teacher.getBirth() != null || teacher.getAddress() != null || teacher.getSalary() != null)) {
				sql.append(" and");
			}

			// teacher.subject.name=?
			if (teacher.getSubject() != null) {
				sql.append(" teacher.subject.name = :subjectName");
			}
			if (teacher.getAccount() != null && (teacher.getCode() != null || teacher.getName() != null
					|| teacher.getPhone() != null || teacher.getAvatarpath() != null || teacher.getGender() != null
					|| teacher.getBirth() != null || teacher.getAddress() != null || teacher.getSalary() != null
			...
			if (teacher.getIsDeleted() != null && (teacher.getCode() != null || teacher.getName() != null
					|| teacher.getPhone() != null || teacher.getAvatarpath() != null || teacher.getGender() != null
					|| teacher.getBirth() != null || teacher.getAddress() != null || teacher.getSalary() != null
					|| teacher.getSubject() != null || teacher.getAccount() != null)) {
				sql.append(" and");
			}
			...
			if (searchKey != null && (teacher.getCode() != null || teacher.getName() != null
					|| teacher.getPhone() != null || teacher.getAvatarpath() != null || teacher.getGender() != null
					|| teacher.getBirth() != null || teacher.getAddress() != null || teacher.getSalary() != null
					|| teacher.getSubject() != null || teacher.getAccount() != null
...
//              OR teacher.subject.id LIKE ? OR teacher.account.id LIKE ?)
		if (searchKey != null) {
			...
			sql.append(" or teacher.subject.name like :searchKey");
...
//        LIMIT ?, ?
	...
	public Query setValueForHQL(Pageable<Teacher> pageable, Session session, String hql) {
		...
		if (teacher != null) {
			...
			if (teacher.getSubject() != null) {
				query.setParameter("subjectName", teacher.getSubject().getName());
			}
			if (teacher.getAccount() != null) {
