...
import com.toanhuuvuong.dao.IOfficeStaffDAO;
import com.toanhuuvuong.model.OfficeStaff;
import com.toanhuuvuong.pagination.Pageable;
import com.toanhuuvuong.sort.Sorter;

public class OfficeStaffDAO extends AbstractHibernateDAO<OfficeStaff> implements IOfficeStaffDAO {
...
//              AND officeStaff.account.id=? AND officeStaff.isDeleted=?
		...
		if (officeStaff != null) {
			...
			if (officeStaff.getCode() != null && officeStaff.getName() != null) {
				sql.append(" and");
			}
			...
			if (officeStaff.getPhone() != null && (officeStaff.getCode() != null || officeStaff.getName() != null)) {
				sql.append(" and");
			}
			...
			if (officeStaff.getAvatarpath() != null && (officeStaff.getCode() != null || officeStaff.getName() != null
			...
			if (officeStaff.getGender() != null && (officeStaff.getCode() != null || officeStaff.getName() != null
					|| officeStaff.getPhone() != null || officeStaff.getAvatarpath() != null)) {
				sql.append(" and");
			}
			...
			if (officeStaff.getBirth() != null
					&& (officeStaff.getCode() != null || officeStaff.getName() != null || officeStaff.getPhone() != null
							|| officeStaff.getAvatarpath() != null || officeStaff.getGender() != null)) {
				sql.append(" and");
			}
			...
			if (officeStaff.getAddress() != null && (officeStaff.getCode() != null || officeStaff.getName() != null
					|| officeStaff.getPhone() != null || officeStaff.getAvatarpath() != null
					|| officeStaff.getGender() != null || officeStaff.getBirth() != null)) {
				sql.append(" and");
			}
			...
			if (officeStaff.getSalary() != null
					&& (officeStaff.getCode() != null || officeStaff.getName() != null || officeStaff.getPhone() != null
							|| officeStaff.getAvatarpath() != null || officeStaff.getGender() != null
							|| officeStaff.getBirth() != null || officeStaff.getAddress() != null)) {
				sql.append(" and");
			}
			...
			if (officeStaff.getAccount() != null && (officeStaff.getCode() != null || officeStaff.getName() != null
					|| officeStaff.getPhone() != null || officeStaff.getAvatarpath() != null
					|| officeStaff.getGender() != null || officeStaff.getBirth() != null
					|| officeStaff.getAddress() != null || officeStaff.getSalary() != null)) {
				sql.append(" and");
			}
			...
			if (officeStaff.getIsDeleted() != null
					&& (officeStaff.getCode() != null || officeStaff.getName() != null || officeStaff.getPhone() != null
							|| officeStaff.getAvatarpath() != null || officeStaff.getGender() != null
							|| officeStaff.getBirth() != null || officeStaff.getAddress() != null
							|| officeStaff.getSalary() != null || officeStaff.getAccount() != null)) {
				sql.append(" and");
			}
			...
			if (searchKey != null && (officeStaff.getCode() != null || officeStaff.getName() != null
					|| officeStaff.getPhone() != null || officeStaff.getAvatarpath() != null
					|| officeStaff.getGender() != null || officeStaff.getBirth() != null
					|| officeStaff.getAddress() != null || officeStaff.getSalary() != null
					|| officeStaff.getAccount() != null || officeStaff.getIsDeleted() != null)) {
				sql.append(" and");
			}
		}
