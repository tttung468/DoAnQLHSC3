...
public class HRStaffAccountController extends GenericController<HRStaff> implements Initializable
{
	// ------------------------------------------- Attributes
	@FXML
	...
	protected boolean update() 
	{
    	...
    	account.setRole(roleService.findByCode("hr-staff"));
    	account = accountService.insertOne(account, accountModel);
    	model.setAccount(account);
    	
    	hrStaffService.updateOne(model, accountModel);
