...
public class TeacherAccountController extends GenericController<Teacher> implements Initializable
{
	// ------------------------------------------- Attributes
	@FXML
	...
	protected boolean update() 
	{
    	...
    	account.setRole(roleService.findByCode("teacher"));
    	account = accountService.insertOne(account, accountModel);
    	model.setAccount(account);
    	
    	teacherService.updateOne(model, accountModel);
